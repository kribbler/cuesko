		...
		if (is_array($active_social_items) && count($active_social_items) > 0)
		{
			...
			<ul class='socials-bottom clearfix'>
				...
				<?php if (in_array('flickr',$active_social_items)): ?>
					<li>
						<a class='flickr' href='<?php echo ot_get_option('flickr_url'); ?>' title="Flickr" target="_blank"></a>
						<div class="cloud">Flickr<div class="helper"></div></div>
					</li>
				<?php endif;?>
				...
				<?php if (in_array('rss',$active_social_items)): ?>
					<li>
						<a class='rss' href='<?php echo ot_get_option('rss_url'); ?>' title="RSS" target="_blank"></a>
