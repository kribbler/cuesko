	...
	function widget($args, $instance)
	{
		...
		if ($r->have_posts()) : ?>
			...
			<ul class="recent_posts_list">
				...
				{
					$image = ts_get_resized_post_thumbnail($post->ID,'latest-posts',get_the_title());
				}
				?>
				<li>
					<span><a title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>" href="<?php the_permalink() ?>"><?php echo $image; ?></a></span>
					<a title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>" href="<?php the_permalink() ?>"><?php echo get_the_title(); ?></a>
